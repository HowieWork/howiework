...
title: 'How my website was built'
slug: 'rethink-a-more-advanced-blog-site'
date: 'Dec 29, 2021'
duration: 'X min read'
...
IMPORTANT [post reference link](https://brianlovin.com/writing/how-my-website-works)

It is a more advanced blog site. It will include features like authentication (user sign up and log in), newsletter subscription feature, show full/featured posts, filter posts, comments etc.
